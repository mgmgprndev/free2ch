...
the project is already stop maintenacnced, and official running website (free2ch[dot]net) is closed & domain expired.
...
# Disclaimer
Please note, please use this at your own risk and There are big differences between free2ch[dot]net (DISCONTINUED) and this repo. <br>
